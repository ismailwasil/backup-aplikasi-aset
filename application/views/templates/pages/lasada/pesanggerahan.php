        ...
        <div class="col-12 col-md-6 order-md-1 order-last">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?= base_url('lasada/bpu_spg') ?>">BPU Sampang</a>
                    ...
                    <a class="dropdown-item" style="color: #435ebe;" href="#"><i class="fa fa-fw fa-lg fa-hand-o-right"></i> Pesanggerahan Ketapang</a>
                </div>
            </div>
        </div>
        <h3>
...
<div class="container-fluid">
    <div class="row g-0 align-items-center flex-md-row">
        ...
        <div class="col-md-6 p-5 mt-lg-5">
            <h1 class="mb-4">#4 Pesanggerahan Ketapang</h1>
            ...
            <small style="color: red;"><strong>NB</strong> : Jika ada penambahan jumlah kursi dari luar gedung, biaya
                sewa kursi ditanggung pihak penyewa</small>
            </p>
            <p>
                <i class="bi bi-geo-alt"></i> <a href="https://goo.gl/maps/HjuejFa29w1isA8N9"> Jl. Trunojoyo, Rw. V,</a>
                <br>Kel. Rong Tengah, Kec. Sampang, Sampang, Jawa Timur, Indonesia <i class="bi bi-mailbox"></i> 69216
            </p>
            <hr>
            <!-- <button type="button" class="btn bg-rent py-3 px-5 mt-3" style="color: #ffffff;" data-bs-toggle="modal" data-bs-target="#pesanggerahan"><strong>Formulir Sewa</strong></button> -->
        </div>
    </div>
</div>
<!-- Header End -->
...
<div class="modal-info me-1 mb-1 d-inline-block">
    <!--info theme Modal -->
    <div class="modal fade text-left" id="pesanggerahan-ktp-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    ...
                    <h4 class="modal-title text-center text-label-header" id="BPU-spg-pk1Title"><img src="<?= base_url('assets/'); ?>images/logo/Sampang.png" alt="Trunojoyo" height="35">
                        Form Sewa Pesanggerahan Ketapang
                    </h4>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative d-none">
                                        <input type="text" class="form-control" value="4" id="aset" name="aset" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
...
<div class="row justify-content-center">
    <div class="card col-xl-8 col-md-6 col-sm-4">
        <div class="row text-center" style="padding: 15px;">
            <h4 style="color: #007753;">Jadwal Sewa Pesanggerahan Ketapang</h4>
...
<script>
    var modal_item = "#pesanggerahan-ktp-modal";
    var get_event_sewa = "<?= base_url('lasada/get_events/4') ?>";
</script>
...
<div class="container-fluid card table-responsive" style="padding: 15px;">
    <div class="row text-center">
        <h4>Daftar Penyewa Pesanggerahan Ketapang</h4>

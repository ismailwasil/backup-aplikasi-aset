        ...
        <div class="col-12 col-md-6 order-md-1 order-last">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" style="color: #435ebe;" href="#"><i class="fa fa-fw fa-lg fa-hand-o-right"></i> Bus Pemda</a>
                    <a class="dropdown-item" href="<?= base_url('lasada/bpu_spg') ?>"></i> BPU Sampang</a>
...
<div class="container-fluid">
    <div class="row g-0 align-items-center flex-md-row">
            ...
            <div id="carouselBPU-spg-1" class="carousel slide partial-border-gradient" data-bs-ride="carousel" style="z-index: 9;">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?= base_url('assets/'); ?>images/lasada/bus.png" class="d-block w-100 responsive" alt="...">
                    </div>
        ...
        <div class="col-md-6 p-5 mt-lg-5">
            <h1 class="mb-4">#1 Bus Pemda Sampang</h1>
            <h5 class="mb-3"><i class="fa fa-fw fa-money"></i> - <small style="color: red; font-size: smaller;">(Belum termasuk biaya sopir)</small></h5>
            <p class="mb-4">Pemerintah Kabupaten Sampang memiliki bus yang bisa dipinjam dengan spesifikasi sebagai berikut:</p>
            <table class="table-responsive" style="width:100%">
                <tr>
                    <th><i class="fa fa-check text-primary me-3"></i>Kursi</th>
                    <th>:</th>
                    <td>36 orang <span style="color: red;">*</span></td>
                </tr>
                <tr>
...
<div class="modal-info me-1 mb-1 d-inline-block">
    <!--info theme Modal -->
    <div class="modal fade text-left" id="Bus-Pemda" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130" aria-hidden="true">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative d-none">
                                        <input type="text" class="form-control" value="5" id="aset" name="aset" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <label for="bukti-ID">
                                        <h6 class="text-label">
                                            ...
                                            Unggah Dokumen Permohonan <span style="color: red;">*</span>
                                        </h6>
                                    </label>
                                    <div class="position-relative">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="catatan_acara">
                                        <h6 class="text-label">
                                            <i class="fa fa-commenting-o"></i> Catatan Sewa
                                        </h6>
                                    </label>
                                    <div class="position-relative">
...
<div class="row justify-content-center">
    <div class="card col-xl-8 col-md-6 col-sm-4">
        <div class="row text-center" style="padding: 15px;">
            <h4 style="color: #007753;">Jadwal Bus Dipinjam</h4>
...
<script>
    var modal_item = "#Bus-Pemda";
    var get_event_sewa = "<?= base_url('lasada/get_events/5') ?>";
</script>
...
<div class="container-fluid card table-responsive" style="padding: 15px;">
    <div class="row text-center">
        <h4>Daftar Peminjam Bus Pemda Sampang</h4>

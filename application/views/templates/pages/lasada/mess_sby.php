        ...
        <div class="col-12 col-md-6 order-md-1 order-last">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" style="color: #435ebe;" href="#"><i class="fa fa-fw fa-lg fa-hand-o-right"></i> Mess Surabaya</a>
...
<div class="container-fluid">
    <div class="row g-0 align-items-center flex-md-row">
        ...
        <div class="col-md-6 p-5 mt-lg-5">
            <h1 class="mb-4">#2 Mess Surabaya</h1>
            ...
            <hr>
            <!-- <button type="button" class="btn bg-rent py-3 px-5 mt-3" style="color: #ffffff;" data-bs-toggle="modal" data-bs-target="#Mess-sby"><strong>Formulir Sewa</strong></button> -->
        </div>
    </div>
</div>
<!-- Header End -->
...
<div class="modal-info me-1 mb-1 d-inline-block">
    <!--info theme Modal -->
    <div class="modal fade text-left" id="Mess-sby-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130" aria-hidden="true">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative d-none">
                                        <input type="text" class="form-control" value="2" id="aset" name="aset" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
...
<div class="row justify-content-center">
    <div class="card col-xl-8 col-md-6 col-sm-4">
        <div class="row text-center" style="padding: 15px;">
            <h4 style="color: #007753;">Jadwal Sewa Mess Surabaya</h4>
...
<script>
    var modal_item = "#Mess-sby-modal";
    var get_event_sewa = "<?= base_url('lasada/get_events/2') ?>";
</script>
...
<div class="container-fluid card table-responsive" style="padding: 15px;">
    <div class="row text-center">
        <h4>Daftar Penyewa Mess Surabaya</h4>

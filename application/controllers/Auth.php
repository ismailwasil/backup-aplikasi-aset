...
class Auth extends CI_Controller
{
    ...
    {
        $id_role = $this->session->userdata('id_role');
        $posisiurl = htmlspecialchars($this->input->post('posisiURL', TRUE));
        $data = '<script>
    ...
    public function kirim()
    {
        ...
        $nama = htmlspecialchars($this->input->post('pengirim', true));
    ...
    {
        $id_role = $this->session->userdata('id_role');
        $no_spm = htmlspecialchars($this->input->post('no_spm', TRUE));
    ...
    {
        $input_username = htmlspecialchars($this->input->post('input_username', TRUE));
    ...
    {
        $idUserDrive = htmlspecialchars($this->input->post('id_user', TRUE));
        $jenisLayananDrive = htmlspecialchars($this->input->post('jenis_layanan', TRUE));
        $passwordDrivebefore = htmlspecialchars($this->input->post('pwdDrive', TRUE));
    ...
    public function edit_bayar($id_bb)
    {
        ...
        // form isian
        $data = [
            'nama_bb'        => htmlspecialchars($this->input->post('nama', TRUE)),
            'alamat_bb'      => htmlspecialchars($this->input->post('alamat', TRUE)),
            'kelurahan_bb'   => htmlspecialchars($this->input->post('kelurahan', TRUE)),
            'kecamatan_bb'   => htmlspecialchars($this->input->post('kecamatan', TRUE)),
            'kabupaten_bb'   => htmlspecialchars($this->input->post('kabupaten', TRUE)),
            'periode_awal'   => ubahFormatTanggal(htmlspecialchars($this->input->post('periode_awal', TRUE)), 'Y-m-d'),
            'periode_akhir'  => ubahFormatTanggal(htmlspecialchars($this->input->post('periode_akhir', TRUE)), 'Y-m-d'),
            'berita_bb'      => htmlspecialchars($this->input->post('berita', TRUE)),
            'nominal_bb'     => htmlspecialchars($this->input->post('nominal', TRUE)),
            'terbilang_bb'   => htmlspecialchars($this->input->post('terbilang', TRUE)),
